...
export const ModalImportConnections = React.memo(
  ({ show, onClose }: IModalImportConnectionsProps) => {
    ...
    return (
      <Modal title="Importar origem" width="640px" show={show} closeOutside onClose={close}>
        <Row>
          <Autocomplete
            required
            clearable={false}
...
ModalImportConnections.displayName = 'ModalImportConnections';

export interface IModalImportConnectionsProps {
  show?: boolean;
  onClose?: () => void;
}
