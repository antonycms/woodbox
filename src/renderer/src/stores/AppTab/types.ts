...
export interface IAppTabStore {
  pendingRemoveTabs?: IPendingRemoveTabs;
  restoreSession(session: {
    tabs: IAppTab[];
    tabGroups?: IAppTabGroup[];
    activeTabId?: string;
  }): void;
  cancelPendingRemoveTabs(): void;
  confirmPendingRemoveTabs(): void;
...
export interface INewAppTab {
  ...
  unsaved?: boolean;
  data?: IAppTabData;
  component: React.ComponentType<{ isActiveTab: boolean }>;
}
...
export interface IPendingRemoveTabs {
  tabId: string | string[];
